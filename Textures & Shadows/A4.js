...
var shadowMap_Camera = new THREE.OrthographicCamera(shadowMapWidth/-2, shadowMapWidth/2, shadowMapHeight/2, shadowMapHeight/-2, 1, 1000); //search this up


//var shadowPosition = new THREE.Vector3(shadowMap_Camera.position.x, shadowMap_Camera.position.y, shadowMap_Camera.position.z );
// TODO: set the camera's lookAt and then add at it to the scene
shadowMap_Camera.position.set(10.0, 15.0, 10.0);
shadowMap_Camera.lookAt(lightDirection);
...
.setPath('images/')
.load(["negx.png", "posx.png", "posy.png", "negy.png", "posz.png", "negz.png"]);
