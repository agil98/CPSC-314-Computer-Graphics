...
var leftLaserPosition = {type: 'v3',  value: new THREE.Vector3(-0.15, 2.42, -0.64)};
var rightLaserPosition = {type: 'v3',  value: new THREE.Vector3(0.15, 2.42, -0.64)};
...
var shaderFiles = [
  ...
  'glsl/laser.vs.glsl'  ,
  'glsl/laser.fs.glsl',
  'glsl/laser(1).vs.glsl'  ,
  'glsl/laser(1).fs.glsl'
...
new THREE.SourceLoader().load(shaderFiles, function(shaders) {
  ...
  rightLaserMaterial.vertexShader = shaders['glsl/laser(1).vs.glsl'];
  rightLaserMaterial.fragmentShader = shaders['glsl/laser(1).fs.glsl'];
...
laser.leftLaser.scale.set(1.0,1.0,1.0);
laser.leftLaser.position.set(1.0, 0, 1.0);
scenes[Part.LASERS].add(laser.leftLaser);

laser.rightLaser = new THREE.Mesh(laser.laserGeometry, rightLaserMaterial);
laser.rightLaser.scale.set(1.0,1.0,1.0);
laser.rightLaser.position.set(rightLaserPosition.value.x, rightLaserPosition.value.y, rightLaserPosition.value.z);
